...
function templateHTML(info){
  if(info.state==='none')return '<section class="template-detail"><div class="eyebrow">AGENT TEMPLATE</div><h3>No Template</h3><p class="info-note">This agent uses the base Vibeguild skill and its free-text role.</p></section>';
